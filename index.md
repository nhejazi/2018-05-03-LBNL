...
address: "1 Cyclotron Road, Berkeley, CA 94720, Building 54, Room 130"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "May 03-04, 2018"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00am - 4:00pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2018-05-03      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2018-05-04        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Nima Hejazi", "Adam Orr"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Nurgul Kaplan", "Shi Wang"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["ecscharfstein@lbl.gov", "ajorr1@asu.edu", "nhejazi@berkeley.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: "http://pad.software-carpentry.org/2018-05-03-LBNL" # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
**Windows users should download and install [PuTTY](http://www.putty.org/).**
